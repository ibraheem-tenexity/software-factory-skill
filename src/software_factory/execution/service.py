"""Factory stage execution: turn a project request into a headless run and advance it safely.
...
from .process import default_launch as _default_launch, proc_state as _proc_state
from .prompts import ProjectRequest, make_prompt_stage1, make_prompt_stage2, make_prompt_stage3
