...
function GraphView({ onOpen, sim, onViewTickets }) {
  return (
      ...
      <div style={{ maxWidth: 720 }}>
        ...
        <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
          ...
          <div style={{ flex: 1, minWidth: 0, paddingBottom: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
              <span style={{ font: `600 14px/1.2 ${T.sans}`, color: T.fg }}>Claude · software-factory</span>
...
Object.assign(window, { PIPELINE, NODE_DETAIL, producedArtifacts, AGENTS, COLS, SEED_TICKETS, KIND_BADGE,
  StageRail, ArtifactChip, GraphNode, GraphView, TagBadge, TicketCard, Kanban, useBuildSim });
