...
const ROSTER = [
  ...
  { name: 'Design Lead', callsign: 'DESIGN.LEAD', sign: 'CHROMA', desc: 'Brand, layout, and design system', model: 'gpt-5-thinking', cost: 3, success: 92, on: true,
    prompt: 'You are Chroma, the Design Lead. Produce the screen designs the build agents implement. Always use the Tenexity design system: brand #1A7BFF, Hanken Grotesk / Georgia / JetBrains Mono, source-labeled AI values, and the archetype library. Map each screen to an archetype, never invent new patterns, and hand off annotated specs.' },
