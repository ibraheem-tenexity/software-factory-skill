...
const DOC_CONTENT = {
  ...
  prd: () => (
    <Md>
      <MdP><b style={{ color: T.fg }}>Product council</b> (3 agents) reconciled research, the company profile, and the process notes into this PRD. Every requirement cites its source inline.</MdP>
      <MdH>1 · Problem</MdH>
...
const MD_GENERIC = {
  ...
  designspec: { intro: 'Design decisions handed to the build agents.', bullets: ['Tenexity system: brand #1A7BFF, Hanken Grotesk, AI values carry sources not confidence tiers.', 'Quote builder uses Catalog + Processing-Queue archetypes.', 'Approval uses the Approval-Stack archetype with keyboard Y/E/N.'] },
