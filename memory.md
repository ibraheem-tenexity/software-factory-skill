...
1. Migration `0035_concierge_product_brief_contract` adds the flexible, judgment-based brief contract to the DB-backed Concierge prompt only when it still exactly matches the 0032 seed; operator-edited prompts are preserved and surfaced for manual reconciliation.
