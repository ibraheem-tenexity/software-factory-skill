// theme.ts — the single source of truth for the inline-style `T` token object, faithful to the
// design's shared.jsx (brand #1A7BFF, Hanken Grotesk / Georgia / JetBrains Mono). Previously
// duplicated verbatim across onboarding/design.tsx and admin/tokens.ts (SOF-11) — both now
// re-export from here.
export const T = {
